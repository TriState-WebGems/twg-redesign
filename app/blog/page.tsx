    ...
    return (
        <AnimatedRoutes>
            <div className='text-center text-2xl py-8 w-4/5 m-auto'>
                ...
                <p className='text-gray-300 text-lg'>Our founder, Gemini, contributes to a blog called Front End Gems. She&apos;ll be exploring perspectives and changes in the web development world, as well as posting tutorials for developers looking to learn and build new things! Go ahead and check it out!</p>
            </div>
