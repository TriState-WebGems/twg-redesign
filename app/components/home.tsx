    ...
    <AnimatedRoutes>
      <div className='w-full h-full'>
        ...
        <section className="flex flex-col items-center justify-center bg-gradient-to-br from-purple-800 to-yellow-400 text-black text-xl py-8">
          <div className="w-3/5 mr-60 col-span-2 translate-y-2">
            <blockquote className="flex flex-col justify-center items-center text-white text-xl p-4 rounded-xl bg-gradient-to-bl from-slate-800 to-yellow-500">
              ...
              <cite>- <Link href="https://instagram.com/gianinecarbonedesigns" target='_blank' className='text-black underline'>Gianine Carbone</Link>, <Link href='https://www.gianinecarbonedesigns.com' className='text-black underline' target='_blank'>Gianine Carbone Designs</Link></cite>
            </blockquote>
          </div>
          <div className="w-3/5 ml-96 -translate-y-2">
            <blockquote className="flex flex-col justify-center items-center  bg-gradient-to-br from-purple-900 to-gray-500 text-white text-xl p-4 rounded-xl">
              ...
              <cite>- <Link href="https://x.com/vivacious0dd" className='text-yellow-400 underline'>vivacious0dd</Link>, Odd Thoughts</cite>
            </blockquote>
          </div>
        </section>
